...
-- My old configs.
-- Do not overwrite the register when copy paste.
vim.keymap.set('x', 'p', 'P', { desc = 'Do not overwrite the register when paste in visual mode' })
...
command! Ht horizontal terminal
